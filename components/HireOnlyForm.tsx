    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div>
          <label htmlFor="roles" className={labelClass}>
            Role(s) to Fill <span className="text-white/40 normal-case tracking-normal font-normal">*</span>
          </label>
          <input
            type="text"
            id="roles"
      ...
      <div>
        <label htmlFor="description" className={labelClass}>
          Role Description <span className="text-white/40 normal-case tracking-normal font-normal">*</span>
        </label>
        <textarea
          id="description"
          name="description"
          ...
          placeholder="Describe the responsibilities, required skills, and any key requirements..."
        />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          <label htmlFor="timeline" className={labelClass}>
            Hiring Timeline <span className="text-white/40 normal-case tracking-normal font-normal">*</span>
          </label>
          <select
            id="timeline"
            name="timeline"
